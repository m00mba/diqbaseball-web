  ...
  return (
    <div style={{
      ...
      <header style={{ background: '#042C53', padding: '14px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <span style={{ color: '#B5D4F4', fontSize: 13 }}>Coach Portal</span>
      </header>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ background: '#fff', borderRadius: 14, padding: 40, width: '100%', maxWidth: 420, boxShadow: '0 2px 12px rgba(0,0,0,0.08)' }}>
          <div style={{ textAlign: 'center', marginBottom: 28 }}>
            <div style={{ fontSize: 22, fontWeight: 800, color: '#042C53' }}>Coach Login</div>
            <div style={{ fontSize: 13, color: '#73726c', marginTop: 4 }}>Upload game stats and manage your roster</div>
          </div>
          ...
          <button
            style={{
              ...
              background: loading ? '#73726c' : '#042C53',
